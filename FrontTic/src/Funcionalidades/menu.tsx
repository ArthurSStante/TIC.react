...
export default function Menu( {username}: Menu) {
        ...
        return(
            <>
            <div className="flex flex-col h-screen overflow-y-auto px-4 py-8 border-r w-[453px] bg-cyan-400 relative mt-[22px]  ">
                    ...
                    <div className={`menu ${isOpen ? 'open' : ''}`}> 
                        <ul className="list-none">
                            <li className="mb-[5em] menu-items">
                                <Link to="/ProdutoCads" className="flex items-center py-2 rounded-md text-black"> 
                                    <MdInventory2 size={40}/>
                                    <span className="font-bold  text-3xl">Cadastro De Produto</span>
                                </Link> 
                            </li>   
                            <li className="mb-6">   
                                <Link to="/" className="flex items-center py-2 rounded-md text-black font-bold"> 
                                    <MdAutorenew size={40} />
