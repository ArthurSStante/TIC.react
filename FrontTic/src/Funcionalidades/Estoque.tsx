...
export function Estoque() {
  ...
  const handleAtualizar = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const produtoCadastrado = await fetch(
      ...
      if (id == 0) {
        ...
        // atualiza na lista o produto alterado
        setProduct(
          vetProduct.map((produto) => {
            if (produto.id === id) {
  ...
  return (
    <>
      <div className="ml-[540px]">
        <div className="flex flex-col ">
          <div className="flex items-center mb-[-20px]">
            ...
            <h1 className="font-normal text-[30px] pl-[5px]"> Estoque </h1>
          </div>
      ...
      <div className="mt-16 flex flex-col items-center">
        ...
        >
          <MdAutorenew size={35} className="ml-[20px]" />{" "}
          <h3 className="text-[20px] ml-[5px]">Atualização </h3>{" "}
        </div>
        <form
          ...
          <div className="flex flex-col items-center">
            <div id="Camp" className="flex flex-col items-center ">
              ...
              <div className="w-8/12 ">
                <label
                  htmlFor="categoria"
                  className="text-sm font-bold mb-2 mr-2 mt-[1em]"
                >
                  Categoria
                </label>
                <input
      ...
      <h2 className="flex flex-col items-center font-bold mt-[80px]">
        {" "}
        Lista de Produtos{" "}
      </h2>
        ...
        <table className="border-collapse">
          ...
          <tbody className="">
            {vetProduct.map((product) => (
              <tr
                key={product.id}
                className=" container-cor-tr rounded-bl-[20px] rounded-br-[20px]"
              >
                ...
                <td className=" px-4 py-2">
                  <button
                    className="border-black border-opacity-50 container-button-C"
